...
{
    [CustomEditor(typeof(IMCScrollRect), true)]
    [CanEditMultipleObjects]
    public class IMCScrollRectEditor : Editor
    {
        SerializedProperty m_Content;
        SerializedProperty m_Horizontal;
        SerializedProperty m_Vertical;
        SerializedProperty m_Dynamic;
        ...
        protected virtual void OnEnable()
        {
            ...
            m_Dynamic = serializedObject.FindProperty("m_Dynamic");
            ...
            m_ViewItem = serializedObject.FindProperty("m_ViewItem");
        ...
        {
            SetAnimBool(m_ShowElasticity, !m_MovementType.hasMultipleDifferentValues && m_MovementType.enumValueIndex == (int)IMCScrollRect.MovementType.Elastic, instant);
        ...
        void CalculateCachedValues()
        {
            ...
            if (targets.Length == 1)
            {
                Transform transform = ((IMCScrollRect)target).transform;
                ...
                if (m_HorizontalScrollbar.objectReferenceValue == null || ((IMCScrollbar)m_HorizontalScrollbar.objectReferenceValue).transform.parent != transform)
                    m_HScrollbarIsNotChild = true;
                if (m_VerticalScrollbar.objectReferenceValue == null || ((IMCScrollbar)m_VerticalScrollbar.objectReferenceValue).transform.parent != transform)
        ...
        public override void OnInspectorGUI()
        {
            ...
            IMCScrollRect scrollRect = (IMCScrollRect)target;
            //EditorGUI.BeginDisabledGroup(true);
            //scrollRect.ControlType = (ControlType)EditorGUILayout.EnumPopup("ControlType", scrollRect.ControlType);
            //scrollRect.ContainerType = (ContainerType)EditorGUILayout.EnumPopup("ContainerType", scrollRect.ContainerType);
            //EditorGUI.EndDisabledGroup();
            scrollRect.customID = EditorGUILayout.TextField("CustomID", scrollRect.customID);
            SetAnimBools(false);
            ...
            IMCScrollRect parent = (IMCScrollRect)target;

            parent.parentScrollRect = EditorGUILayout.ObjectField("Parent", parent.parentScrollRect, typeof(IMCScrollRect)) as IMCScrollRect;

            EditorGUILayout.PropertyField(m_Content);

            EditorGUILayout.PropertyField(m_Horizontal);
            EditorGUILayout.PropertyField(m_Vertical);
            EditorGUILayout.PropertyField(m_Dynamic);
            ...
            EditorGUILayout.PropertyField(m_ViewItem);
            ...
            if (m_HorizontalScrollbar.objectReferenceValue && !m_HorizontalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((IMCScrollRect.ScrollbarVisibility)m_HorizontalScrollbarVisibility.enumValueIndex == IMCScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport
            ...
            if (m_VerticalScrollbar.objectReferenceValue && !m_VerticalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((IMCScrollRect.ScrollbarVisibility)m_VerticalScrollbarVisibility.enumValueIndex == IMCScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport

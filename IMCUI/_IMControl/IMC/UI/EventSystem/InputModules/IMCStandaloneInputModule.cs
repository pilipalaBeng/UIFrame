...
namespace IMCUI.UI
{
    [AddComponentMenu("IMCUI/IMC Standalone Input Module",82)]
    public class IMCStandaloneInputModule : PointerInputModule
    {
        ...
        protected IMCStandaloneInputModule()
        {}
        ...
        #region ExpandStandaloneInputModule

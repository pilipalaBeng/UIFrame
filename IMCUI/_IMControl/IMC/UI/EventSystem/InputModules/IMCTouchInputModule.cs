...
namespace IMCUI.UI
{
    [AddComponentMenu("IMCUI/IMC Touch Input Module", 86)]
    public class IMCTouchInputModule : PointerInputModule
    {
        protected IMCTouchInputModule()
        { }

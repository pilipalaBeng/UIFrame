...
namespace IMCUI.UI
{
    [AddComponentMenu("IMCUI/IMCScroll Rect", 37)]
    [SelectionBase]
    [ExecuteInEditMode]
    [DisallowMultipleComponent]
    [RequireComponent(typeof(RectTransform))]
    public class IMCScrollRect : IMCUIContainer, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup, IPointerDownHandler
    {
        [Space(20)]
        [SerializeField]
        private IMCScrollRect m_parentScrollRect;
        public IMCScrollRect parentScrollRect
        {
            get { return m_parentScrollRect; }
            set { m_parentScrollRect = value; }
        }
        ...
        [SerializeField]
        private IMCViewItem m_ViewItem = null;
        public IMCViewItem viewitem { get { return m_ViewItem; } set { m_ViewItem = value; } }

        [SerializeField]
        private IMCScrollbar m_HorizontalScrollbar;
        public IMCScrollbar horizontalScrollbar
        {
            get
            {
        ...
        [SerializeField]
        private IMCScrollbar m_VerticalScrollbar;
        public IMCScrollbar verticalScrollbar
        {
            get
            {
        ...
        [SerializeField]
        private ScrollRectEvent m_OnBeginDrag = new ScrollRectEvent();
        public ScrollRectEvent onBeginDrag
        {
        ...
        [SerializeField]
        private ScrollRectEvent m_OnDrag = new ScrollRectEvent();
        public ScrollRectEvent onDrag
        {
            get { return m_OnDrag; }
            set { m_OnDrag = value; }
        }
        ...
        [SerializeField]
        private ScrollRectEvent m_OnEndDrag = new ScrollRectEvent();
        ...
        public virtual void OnBeginDrag(PointerEventData eventData)
        {
            ...
            if (!vertical || !horizontal)
            {
                float delteriao = Mathf.Abs(eventData.delta.y / eventData.delta.x);
                if (delteriao >= 1)
                {
                    if (horizontal)
                        return;
        ...
        public void OnPointerDown(PointerEventData eventData)
        {
            if (m_parentScrollRect)
            {
                m_parentScrollRect.OnPointerDown(eventData);
            }
            m_Velocity = Vector2.zero;
        }
        #region ExpandScrollRect
        ...
        [Obsolete("please call RemoveAllControl .")]
        ...
        /// <summary>
        /// 将list的元素依次被调用进IMCScrollRect中的AddControl的方法
        /// </summary>
        //public void AddControls(List<IMCUIBehaviour> list)
        //{
        ...
        //    }
        //}
        //public override void AddControl(IMCUIBehaviour control)//2017年7月4日14:45:46 删除该方法，与父类方法冲突
        //{
        ...
        {
            base.Awake();
            m_controlType = ControlType.IMCScrollRect;
        }

...
namespace IMCUI.UI
{
    [AddComponentMenu("IMCUI/IMC Graphic Raycaster", 83)]
    [RequireComponent(typeof(Canvas))]
    public class IMCGraphicRaycaster : BaseRaycaster
    {
        ...
        protected override void Awake()
        {
            ...
            m_containerType = ContainerType.Other;
        }
        internal void RaycastSwitch(bool isSwitch)
        {

...
namespace IMCUI.UI
{
    [AddComponentMenu("IMCUI/IMCMask", 13)]//2017年5月25日15:15:33 
    [ExecuteInEditMode]
    [RequireComponent(typeof(RectTransform))]
    [DisallowMultipleComponent]
    public class Mask : IMCUIBehaviour, ICanvasRaycastFilter, IMaterialModifier
    {
        [NonSerialized]
        ...
        protected override void Awake()//2017年5月25日10:48:35 mask 自动更改枚举
        {
            base.Awake();

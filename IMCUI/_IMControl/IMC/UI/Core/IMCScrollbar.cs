...
namespace IMCUI.UI
{
    [AddComponentMenu("IMCUI/IMCScrollbar", 34)]
    [RequireComponent(typeof(RectTransform))]
    public class IMCScrollbar : IMCSelectable, IBeginDragHandler, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        ...
        #region ExpandScrollbar
       
        protected override void Awake()
        {
            base.Awake();
            m_controlType = ControlType.IMCScrollbar;

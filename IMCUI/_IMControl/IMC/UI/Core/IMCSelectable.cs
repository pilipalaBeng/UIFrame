...
namespace IMCUI.UI
{
    ...
    [AddComponentMenu("IMCUI/Selectable", 70)]
    [ExecuteInEditMode]
    [SelectionBase]
    [DisallowMultipleComponent]
    public class IMCSelectable
        :
        IMCUIBehaviour,
        IMoveHandler,
        ...
        ISelectHandler, IDeselectHandler
    {
        ...
        private static List<IMCSelectable> s_List = new List<IMCSelectable>();
        public static List<IMCSelectable> allSelectables { get { return s_List; } }
        ...
        public IMCSelectable FindSelectable(Vector3 dir)
        {
            dir = dir.normalized;
            Vector3 localDir = Quaternion.Inverse(transform.rotation) * dir;
            Vector3 pos = transform.TransformPoint(GetPointOnRectEdge(transform as RectTransform, localDir));
            float maxScore = Mathf.NegativeInfinity;
            IMCSelectable bestPick = null;
            for (int i = 0; i < s_List.Count; ++i)
            {
                IMCSelectable sel = s_List[i];
        ...
        void Navigate(AxisEventData eventData, IMCSelectable sel)
        {
        ...
        public virtual IMCSelectable FindSelectableOnLeft()
        {
        ...
        public virtual IMCSelectable FindSelectableOnRight()
        {
            if (m_Navigation.mode == Navigation.Mode.Explicit)
            {
        ...
        public virtual IMCSelectable FindSelectableOnUp()
        {
            if (m_Navigation.mode == Navigation.Mode.Explicit)
            {
        ...
        public virtual IMCSelectable FindSelectableOnDown()
        {
            if (m_Navigation.mode == Navigation.Mode.Explicit)
            {
        ...
        protected void EvaluateAndTransitionToSelectionState(BaseEventData eventData)//2017年9月5日21:37:08  private改protected
        {
            if (!IsActive())
                return;

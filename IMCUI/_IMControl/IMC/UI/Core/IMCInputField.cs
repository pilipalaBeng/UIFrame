...
namespace IMCUI.UI
{
    ...
    [AddComponentMenu("IMCUI/IMCInput Field", 31),RequireComponent(typeof(IMCImage))]
    public class IMCInputField
        : IMCSelectable,
        ...
        ICanvasElement
    {
        ...
        protected IMCText m_TextComponent;
        ...
        public IMCText textComponent { get { return m_TextComponent; } set { SetPropertyUtility.SetClass(ref m_TextComponent, value); } }
        ...
        private void OnFillVBO(Mesh vbo)
        {
            using (var helper = new VertexHelper())
            {
                ...
                Vector2 textAnchorPivot = IMCText.GetTextAnchorPivot(m_TextComponent.alignment);
        ...
        #region ExpandInputField
        protected override void Awake()
        {
            base.Awake();
            m_controlType = ControlType.IMCInputField;

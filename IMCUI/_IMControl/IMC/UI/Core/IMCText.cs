...
namespace IMCUI.UI
{
    ...
    [AddComponentMenu("IMCUI/IMCText", 10)]
    public class IMCText : MaskableGraphic, ILayoutElement
    {
        [SerializeField]
        ...
        {
            base.Awake();
            m_controlType = ControlType.IMCText;
        ...
        ///// <returns></returns>
        //public string ConvertUrl(string url, string display = null)
        //{

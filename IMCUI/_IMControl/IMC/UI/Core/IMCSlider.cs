...
namespace IMCUI.UI
{
    [AddComponentMenu("IMCUI/IMCSlider", 33)]
    [RequireComponent(typeof(RectTransform))]
    public class IMCSlider : IMCSelectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
    {
        ...
        protected override void OnDidApplyAnimationProperties()
        {
            ...
            {
                if (m_FillImage != null && m_FillImage.type == IMCImage.Type.Filled)
        ...
        public override IMCSelectable FindSelectableOnLeft()
        {
        ...
        public override IMCSelectable FindSelectableOnRight()
        {
            if (navigation.mode == Navigation.Mode.Automatic && axis == Axis.Horizontal)
                return null;
        ...
        public override IMCSelectable FindSelectableOnUp()
        {
        ...
        public override IMCSelectable FindSelectableOnDown()
        {
            if (navigation.mode == Navigation.Mode.Automatic && axis == Axis.Vertical)
                return null;
        ...
        #region ExpandSlider
        protected override void Awake()//2017年5月25日09:48:41   添加slider自动更改 枚举
        {
            base.Awake();
            m_controlType = ControlType.IMCSlider;
